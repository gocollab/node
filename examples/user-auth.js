...
app.get('/', function(req, res){
	if( req.user ){
		...
		//var auth =
		res.send('<html><body><a href="/auth/gocollab">Login</a></body></html>');
	}
	res.end();
});


app.get('/auth/gocollab', gocollab.auth());

app.get('/auth/gocollab/callback', gocollab.auth({ successRedirect: '/', failureRedirect: '/'}) );
