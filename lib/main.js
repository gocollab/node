var _ = require("underscore"),
	...
	Strategy = require("passport-gocollab").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/gocollab/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('gocollab', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('gocollab', arguments[0]);
		}
	},
